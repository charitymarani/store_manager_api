...
class TestSales(BaseTestCase):
    ...
    def test_get_all_sales(self):
        ...
        with self.client:
            ...
            responseb=self.client.get('api/v1/sales',headers=dict(Authorization="Bearer " + token1))
    ...
    def test_get_sale_by_id(self):
        with self.client:
            ...
            result_login_attendant2=json.loads(response_login_attendant2.data)
            ...
            responseatt2=self.client.get('api/v1/sales/1',headers=dict(Authorization="Bearer " + a_token1))
